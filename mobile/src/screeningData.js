// Screening tool question sets + scoring logic — ported from
// ../../js/screening-data.js (the web app's copy) with only the export
// statement changed (window.X = X → ES module export). Keep both in sync
// if the clinical logic ever changes.
//
...
export const SCREENING_TIERS = TIERS;
export { SCREENING_CATEGORIES };
